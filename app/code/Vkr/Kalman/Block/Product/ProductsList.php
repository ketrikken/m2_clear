...
namespace Vkr\Kalman\Block\Product;
...
class ProductsList extends \Magento\Catalog\Block\Product\AbstractProduct implements BlockInterface, IdentityInterface
{
    ...
    public function getCacheKeyInfo()
    {
        ...
        return [
            'CATALOG_PRODUCTS_KALMAN_LIST_WIDGET',
    ...
    {
        return explode(',', $this->getData('show_buttons'));
    }
    public function isAddToCartEnabled()
    {
        return in_array('add_to_cart', $this->getButtons());
    }
    public function isAddToCompareEnabled()
    {
        return in_array('add_to_compare', $this->getButtons());
    }
    public function isAddToWishlistEnabled()
    {
        return in_array('add_to_wishlist', $this->getButtons());
    }
